...
BASEDIR = path.join(path.dirname(path.dirname(path.abspath(__file__))), 'data')
...
if OILAUTH:
    LOGIN_URL = "/store/login/fiware/"
    LOGIN_REDIRECT_URL = '/store'
    LOGIN_ERROR_URL = '/login-error'
    SOCIAL_AUTH_DISCONNECT_REDIRECT_URL = "/store/login/fiware/"
else:
    LOGIN_URL = '/login/'
...
RESOURCE_INDEX_DIR = path.join(BASEDIR, path.join('admin', 'indexes'))
