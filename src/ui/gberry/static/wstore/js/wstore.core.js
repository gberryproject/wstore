...
(function () {
  ...
  wstore_urlpatterns = {
    marketplaces: {
      collection: '/store/api/administration/marketplaces/',
      entry: '/store/api/administration/marketplaces/${name}',
    },
    organizations: {
      collection: '/store/api/administration/organizations/',
      entry: '/store/api/administration/organizations/${name}',
      user_collection: '/store/api/administration/organizations/${name}/users/',
    },
    repositories: {
      collection: '/store/api/administration/repositories/',
      entry: '/store/api/administration/repositories/${name}',
    },
    resources: {
      search: '/store/api/administration/search',
    },
    rss: {
      collection: '/store/api/administration/rss/',
      entry: '/store/api/administration/rss/${name}',
    },
    users: {
      collection: '/store/api/administration/profiles/',
      entry: '/store/api/administration/profiles/${username}/',
    },
  };
